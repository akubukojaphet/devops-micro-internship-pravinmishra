...
![Screenshot 1 — VPC details showing CIDR 10.0.0.0/16](screenshots/01-epicbook-vpc.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![Screenshot 2 — Subnets list showing both subnets and their CIDRs](screenshots/02-epicbook-subnets.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Screenshot 3 — Route table showing public route to Internet Gateway](screenshots/03-epicbook-public-route-table.png)
...
![Screenshot 4 — EC2 security group inbound rules](screenshots/04-epicbook-ec2-security-group.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![Screenshot 5 — RDS security group inbound rule](screenshots/05-epicbook-rds-security-group.png)
...
![Screenshot 6 — EC2 instance summary](screenshots/06-epicbook-ec2-instance.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Screenshot 7 — Successful SSH login](screenshots/07-epicbook-ssh-login.png)
...
![Screenshot 8 — Node.js and npm versions](screenshots/08-epicbook-node-npm.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Screenshot 9 — Nginx service status](screenshots/09-epicbook-nginx-status.png)

---

#### Screenshot 10 — Output of `mysql --version`

![Screenshot 10 — MySQL client version](screenshots/10-epicbook-mysql-version.png)
...
![Screenshot 11 — RDS instance showing private access](screenshots/11-epicbook-rds-private.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![Screenshot 12 — RDS connectivity and security](screenshots/12-epicbook-rds-connectivity.png)
...
![Screenshot 13 — Successful database tables query](screenshots/13-epicbook-database-tables.png)
...
![Screenshot 14 — EpicBook repository cloned](screenshots/14-epicbook-repository.png)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![Screenshot 15 — EpicBook backend running](screenshots/15-epicbook-backend-running.png)

---

#### Screenshot 16 — `curl` output proving the backend responds; a 200, 301, or 404 response is acceptable if the service responds

![Screenshot 16 — Backend curl response](screenshots/16-epicbook-backend-curl.png)
...
![Screenshot 17 — Nginx configuration test successful](screenshots/17-epicbook-nginx-test.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Screenshot 18 — Nginx configuration showing API reverse proxy](screenshots/18-epicbook-nginx-config.png)
...
![Screenshot 19 — EpicBook application loaded in browser](screenshots/19-epicbook-frontend.png)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint, such as `curl http://<EC2_PUBLIC_IP>/api/...`

![Screenshot 20 — Successful EpicBook API call through public endpoint](screenshots/20-epicbook-api-test.png)

---

#### Screenshot 21 — Terminal showing the successful database connectivity test using `SELECT 1;` or similar

![Screenshot 21 — Successful RDS database connectivity test](screenshots/21-epicbook-database-test.png)
