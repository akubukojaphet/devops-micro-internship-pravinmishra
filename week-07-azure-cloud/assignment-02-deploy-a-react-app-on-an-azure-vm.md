...
![Node.js and npm Versions](screenshots/05-node-and-npm-versions.png)
...
![React Build Success](screenshots/06-react-build-success.png)
...
![Nginx Configuration Test](screenshots/07-nginx-configuration-test.png)

---

#### Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive

![Nginx Configuration](screenshots/08-nginx-react-configuration.png)
...
![Live React App](screenshots/09-react-app-live-public-ip.png)
...
![SSH Restricted to My IP](screenshots/10-ssh-restricted-to-my-ip.png)
